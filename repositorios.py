...
class RepositorioEmpleadoSQLite(RepositorioEmpleado):
    ...
    def guardar(self, empleado: Empleado):
        with self.conexion() as conn:
            conn.execute(""" INSERT INTO empleados (DPI, primer_nombre, segundo_nombre, otro_nombre, primer_apellido, segundo_apellido, otro_apellido, usuario, contraseña, fecha_nacimiento) 
