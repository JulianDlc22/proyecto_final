...
class IngresoEmpleado:
    ...
    def ingreso_empleado(self, page: ft.Page):
        ...
        def mostrar_mensaje(titulo, mensaje, tipo="info"):
            color = "#0E4B40" if tipo == "exito" else "#B00020"
        ...
        def guardar_empleado(e):
            if not (DPI.value and primer_nombre.value and segundo_nombre.value and primer_apellido.value and segundo_apellido.value and usuario.value and contraseña.value):
                mostrar_mensaje("Error", "Debe ingresar todos los campos obligatorios", tipo="error")
                return
            ...
            mostrar_mensaje("Éxito", "Empleado guardado correctamente", tipo="exito")
        ...
        page.add(DPI, primer_nombre, segundo_nombre, otro_nombre, primer_apellido, segundo_apellido, otro_apellido, usuario, contraseña, boton_guardar)
